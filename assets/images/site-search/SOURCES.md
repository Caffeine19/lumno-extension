...
- Kagi uses the official Search product artwork from Kagi's brand asset kit (`https://kagi.com/asset/dc5d193/kagi_assets/logos/search.png`), normalized into the shared 144px runtime tile.
